...
exports.increment = (req, res) => {
  ...
  if(req.body.custom_number) {
    ...
    fs.writeFile(__dirname + '/../public/data.txt', req.body.custom_number, function() {
    ...
    fs.writeFile(__dirname + '/../public/data.txt', number, function() {
...
exports.viewPage = (req, res) => {
  let number = fs.readFileSync(__dirname + '/../public/data.txt', 'utf8');
